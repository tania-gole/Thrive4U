...
## 0. Browser tab + Site description (SEO)

| Field | Current text |
|---|---|
| Browser tab title | Thrive4U |
| Site description (shows in Google + when shared) | Thrive4U Coaching & Consulting — Sanah Singh Tomar, ICF Master Certified Coach (MCC) and EMCC Senior Practitioner. Partnering with women leaders, high potentials, and C-suite executives for real, measurable transformation. |
...
**Pillar 1 — Reflect** (gold card)
> We begin by holding up a mirror. Uncovering your patterns, beliefs, and blind spots so you can see yourself with full clarity and without judgement.

**Pillar 2 — Root** (red card)
> We go deep. Identifying your values, strengths, and the core beliefs that either anchor or limit you, building the foundation for lasting change.

**Pillar 3 — Rise** (gold card)
> We build upward. Developing new habits, behaviours, and ways of thinking that allow you to grow consciously and lead with greater impact.

**Pillar 4 — Thrive** (red card)
> We move. With clarity, confidence, and intention, you step forward into your next chapter, fully equipped for the complexity ahead.

### Closing quote

| Field | Current text |
|---|---|
| Quote | "Meaningful change isn't accidental. It's consciously created." |
| Sub-line | Each pillar builds on the last. Together they form a complete journey, from awareness to action, from insight to transformation. This is how real, lasting change happens. |
